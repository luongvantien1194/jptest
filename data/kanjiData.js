const kanjiData = [
  ...
  },
  {
    ...
    "logic_development": "丿-phiệt + 十-thập → (千) một nghìn",
  ...
  },
  {
    ...
    "logic_development": "小-tiểu + 丿-phiệt → (少) số lượng nhỏ",
  ...
  },
  {
    ...
    "logic_development": "刂-đao + 止-chỉ + 巾-cân → (帰) trở về",
  ...
  },
  {
    ...
    "logic_development": "雨-vũ + 彐-kệ → (雪) tuyết rơi",
  ...
  },
  {
    ...
    "logic_development": "女-nữ + 彐-kệ → (妻) người vợ",
  ...
  },
  {
    ...
    "kun_reading": "ある",
    "stroke_count": 6,
    "radicals": "月-nguyệt|𠂇-tả",
    "core_meaning": "Có",
    "story_image": "Bàn tay (ナ) đang cầm miếng thịt (月) để sở hữu.",
    "logic_development": "𠂇-tả + 月-nguyệt → (有) sở hữu",
  ...
  },
  {
    ...
    "level": "n45",
      ...
      "kun_reading": "せい",
      "stroke_count": 8,
      "radicals": "制-chế|刂-đao",
      "core_meaning": "chế độ",
      "story_image": "Dùng dao (リ) để cắt may quần áo theo quy chế (制).",
      "logic_development": "制-chế + 刂-đao → dùng dao cắt chế độ",
    ...
    "level": "n45",
      ...
      "kun_reading": "ま|まこと",
      "stroke_count": 10,
      "radicals": "十-thập|目-mục|乚-ẩn|八-bát",
      "core_meaning": "chân thật",
      "story_image": "Mười (十) con mắt (目) cùng nhìn thấu sự thật ẩn giấu (乚).",
      "logic_development": "十-thập + 目-mục + 乚-ẩn + 八-bát → mười mắt nhìn sự thật",
    ...
    "level": "n45",
      ...
      "kun_reading": "あか|あか.い",
      "stroke_count": 7,
      "radicals": "土-thổ|八-bát",
      "core_meaning": "màu đỏ",
      "story_image": "Lửa cháy dưới đất (土) tỏa ra (ハ) sắc đỏ.",
      "logic_development": "土-thổ + 八-bát → lửa cháy dưới đất",
    ...
    "level": "n45",
      ...
      "kun_reading": "さむ.い",
      "stroke_count": 12,
      "radicals": "宀-miên|井-tỉnh|八-bát",
      "core_meaning": "lạnh (thời tiết)",
      "story_image": "Trong nhà (宀) có đống rơm khô (井) và băng (ハ) nên lạnh.",
      "logic_development": "宀-miên + 井-tỉnh + 八-bát → rơm và băng trong nhà",
    ...
    "level": "n45",
      ...
      "logic_development": "扌-thủ + 厶-khứ → tay đẩy nợ đi",
    ...
    "level": "n45",
      ...
      "logic_development": "至-chí + 刂-đao → đến nơi dùng dao",
    ...
    "level": "n45",
      ...
      "logic_development": "害-hại + 刂-đao → dùng dao cắt vật hại",
    ...
    },
    {
      ...
      "core_meaning": "Đích, mục tiêu, ~tính",
      "story_image": "Cái thìa (勺) màu trắng (白) là mục tiêu để nhắm vào.",
      "logic_development": "白-bạch + 勺-chước → thìa trắng là mục tiêu để nhắm đến",
